...
public final class LiftChimePlayer {
    ...
    private static final ResourceLocation LIFT_MUSIC =
            ResourceLocation.fromNamespaceAndPath("smoothlift", "audio/liftmusic");
    ...
    private static final ResourceLocation LIFT_UP =
            ResourceLocation.fromNamespaceAndPath("smoothlift", "audio/up");
    ...
    private static final ResourceLocation LIFT_DOWN =
            ResourceLocation.fromNamespaceAndPath("smoothlift", "audio/down");
