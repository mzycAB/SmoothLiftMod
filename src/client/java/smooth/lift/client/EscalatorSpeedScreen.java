...
public class EscalatorSpeedScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new Button(this.width / 2 - 100, 102, 200, 20,
        ...
        // 【1.7】自定义声音：音乐选择子界面入口
        addRenderableWidget(new Button(this.width / 2 - 100, 162, 200, 20,
                Component.literal("声音设置…"), button -> openAudioSetup()));
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        GuiComponent.drawCenteredString(poseStack, this.font, this.title, this.width / 2, 18, 0xFFFFFF);
        GuiComponent.drawCenteredString(poseStack, this.font, Component.literal("扶梯速度（格/秒）"),
                this.width / 2, 32, 0xA0A0A0);
        GuiComponent.drawCenteredString(poseStack, this.font, Component.literal("阶梯速度（格/秒）"),
                this.width / 2, 68, 0xA0A0A0);
        GuiComponent.drawCenteredString(poseStack, this.font, Component.literal("声音音量（1-1000，100 = 原始音量，可放大）"),
