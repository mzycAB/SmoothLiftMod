...
/**
 * Helper for working with {@link class_3300} instances, and other resource loader generalities.
 */
...
public interface ResourceManagerHelper {
	 ...
	 * @param activationType the activation type of the resource pack
	 * @return {@code true} if successfully registered the resource pack, else {@code false}
	 * @deprecated Use {@link #registerBuiltinResourcePack(class_2960, ModContainer, class_2561, ResourcePackActivationType)} instead.
	 */
	@Deprecated
	 ...
	 * @return {@code true} if successfully registered the resource pack, else {@code false}
	 * @deprecated Please use {@link #registerBuiltinResourcePack(class_2960, ModContainer, ResourcePackActivationType)} instead, the {@code sub path} should be removed in a future
