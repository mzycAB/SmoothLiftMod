...
# 1.21.x 的工程用 sourceCompatibility/targetCompatibility = JavaVersion.VERSION_21，
# 老工程用 toolchain 的 JavaLanguageVersion.of(21) —— 两种写法都要认。
if grep -qE 'JavaLanguageVersion\.of\(21\)|JavaVersion\.VERSION_21' build.gradle; then
