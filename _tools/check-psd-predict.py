...
PLAYER = os.path.join(ROOT, "src", "main", "java", "smooth", "lift", "client", "PsdChimePlayer.java")
...
ACCESS = os.path.join(ROOT, "src", "main", "java", "smooth", "lift", "client", "MtrDwellAccess.java")
